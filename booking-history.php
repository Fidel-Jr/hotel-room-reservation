<?php
    ...
    $sql = "SELECT booking_history.*, booking_history.id as bh_id, room.id, room.room_number, room_type.room_type, room_type.id as room_type_id FROM booking_history INNER JOIN room ON booking_history.room_id = room.id INNER JOIN room_type ON room_type.id = room.room_type HAVING booking_history.user_id = '$user_id' ORDER BY booking_history.booking_date DESC LIMIT 10";
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                ?>
                                                    <td>
                                                        <a href="rate.php?id=<?php echo $row['bh_id']; ?>" class="btn btn-primary">Rate</a>
                                                    </td>
                                                <?php
                                                    }
